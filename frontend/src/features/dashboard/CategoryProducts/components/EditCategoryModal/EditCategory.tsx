...
import { useEditCategoryForm } from "../../hooks/useCategories";
...
export const EditCategoryModal: React.FC<EditCategoryModalProps> = ({
  ...
  const {
    ...
    handleSubmit,
    removeIcon
  } = useEditCategoryForm({ isOpen, category, onClose, onSave });
          ...
          <div>
            ...
            <div className="flex flex-col items-center">
              <input
                ...
                className="hidden"
                id="icono-upload-edit"
                accept="image/*"
                ref={fileInputRef}
              />

              {/* Círculo del icono - Clickable (SOLO ESTE ELEMENTO MANEJA EL CLICK) */}
              <div
              ...
              <div className="text-center">
                <div className="text-xs text-gray-500 mb-1">
                  {currentIcon ? "Haga clic en el círculo para cambiar el icono" : "Haga clic en el círculo para seleccionar un icono"}
                </div>

                {currentIcon && (
                  <div className="flex flex-col items-center space-y-1">
                    <div className="text-xs text-green-600 font-medium">
                      {currentIcon.name || "Icono seleccionado"}
                    </div>
                    <button
                      type="button"
                      onClick={(e) => {
