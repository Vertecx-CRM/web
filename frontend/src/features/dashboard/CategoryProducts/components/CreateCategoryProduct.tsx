                        ...
                        <div>
                            ...
                            <div className="border border-dashed border-gray-300 rounded-md p-4 text-center">
                                <input
                                    ...
                                    accept="image/*"
                                />
                                <label htmlFor="icono-upload" className="cursor-pointer flex flex-col items-center">
                                    <div className="text-sm text-gray-500 mb-2">Seleccione el icono de la categoría del producto (opcional)</div>
                                    {formData.icono ? (
