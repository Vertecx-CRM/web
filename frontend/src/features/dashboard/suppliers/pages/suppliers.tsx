...
const MOCK: Row[] = [
  ...
  {
    id: 11,
    name: "Licencias & Suites S.A.S.",
    nit: "901667788-9",
    rating: 4.5,
    contact: "Andrés Ospina",
    category: "Software",
    status: "Activo",
  },
  {
    id: 12,
    name: "Monitores Bogotá",
    nit: "860445566-0",
    rating: 3.6,
    contact: "Carolina Vélez",
    category: "Periféricos",
    status: "Activo",
  },
  {
    id: 13,
    name: "Componentes del Café",
    nit: "800223344-2",
    rating: 4.2,
    contact: "Mateo Ballesteros",
    category: "Equipos",
    status: "Activo",
  },
  {
    id: 14,
    name: "UPS Latam Power",
    nit: "901778899-4",
    rating: 3.4,
    contact: "Juliana Patiño",
    category: "Energía",
    status: "Inactivo",
  },
  {
    ...
    nit: "900314159-2",
    rating: 4.8,
    contact: "Felipe Moncada",
    category: "Servidores",
    status: "Activo",
  },
  {
    id: 16,
    name: "Periféricos del Valle",
    nit: "890778899-5",
    rating: 3.7,
    contact: "Valeria Ocampo",
    category: "Periféricos",
    status: "Activo",
  },
  {
    id: 17,
    name: "RedNube Integradores",
    nit: "901909182-6",
    rating: 4.1,
    contact: "Luis Eduardo Mora",
    category: "Nube",
    status: "Activo",
  },
  {
    id: 18,
    name: "Seguridad Digital Andes",
    nit: "901515151-3",
    rating: 3.1,
    contact: "Natalia Pineda",
    category: "Seguridad",
    status: "Inactivo",
  },
  {
    id: 19,
    name: "SSD & Storage Pro",
    nit: "860909090-7",
    rating: 4.6,
    contact: "Óscar Restrepo",
    category: "Almacenamiento",
    status: "Activo",
  },
  {
    id: 20,
    name: "OfficeCloud Licenciamiento",
    nit: "901121212-9",
    rating: 4.0,
    contact: "Camila Bernal",
    category: "Software",
    status: "Activo",
  },
  {
    id: 21,
    name: "Andes Rack & Switch",
    nit: "900135791-1",
    rating: 3.5,
    contact: "Juanita Gómez",
    category: "Redes",
    status: "Activo",
  },
  {
    id: 22,
    name: "Atlántico IT Services",
    nit: "901246810-2",
    rating: 4.3,
    contact: "Miguel Ángel Rincón",
    category: "Servidores",
    status: "Activo",
  },
  {
    id: 23,
    name: "EcoPower Respaldo",
    nit: "900753951-4",
    rating: 2.8,
    contact: "Esteban Salazar",
    category: "Energía",
    status: "Inactivo",
  },
  {
    id: 24,
    name: "Cables & Fibras del Sur",
    nit: "800369258-6",
    rating: 3.9,
    contact: "Paula Cruz",
    category: "Redes",
  ...
  {
    id: 25,
    name: "ComputeMax Distribuciones",
    nit: "901468024-3",
    rating: 4.4,
    contact: "Andrés Felipe Rueda",
    category: "Equipos",
    status: "Activo",
  },
  {
    id: 26,
    name: "Print&Scan Solutions",
    nit: "900642864-0",
    rating: 3.0,
  ...
  {
    id: 27,
    name: "Backup Andes Cloud",
    nit: "901852741-5",
    rating: 4.7,
    contact: "Tomás Cárdenas",
    category: "Nube",
    status: "Activo",
  },
  {
    ...
    nit: "901333222-1",
    rating: 3.3,
    contact: "Silvia Herrera",
    category: "Seguridad",
    status: "Inactivo",
  },
  {
    id: 29,
    name: "HDD Andino Mayorista",
    nit: "890321654-3",
    rating: 3.8,
    contact: "Ricardo Téllez",
    category: "Almacenamiento",
    status: "Activo",
  },
  {
    id: 30,
    name: "VirtualApps Licenses",
    nit: "901707070-0",
    rating: 4.2,
    contact: "Mariana Cifuentes",
    category: "Software",
    status: "Activo",
  },
];
