...
const MOCK: Row[] = [
  ...
  },
  {
    id: 3,
    documento: "CC",
    numeroDocumento: "1221302283",
    nombre: "Denier Alvarez",
    telefono: "3016245207",
    email: "negatiedi@gmail.com",
    rol: "Nexino",
    estado: "Activo",
  },
  {
  ...
  },
  {
    ...
    nombre: "Juan Pablo Cabal",
    telefono: "3109876543",
    email: "juan.cabal@email.com",
    rol: "Usuario",
    estado: "Activo",
  },
  {
  ...
  },
  {
    ...
    telefono: "3223344556",
    email: "daniel.castano@email.com",
    rol: "Usuario",
    estado: "Inactivo",
  },
  {
  ...
  },
  {
    ...
    nombre: "Daniela Hoyos",
    telefono: "3118899001",
    email: "daniela.hoyos@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
  ...
  },
  {
    ...
    telefono: "3220011223",
    email: "carolina.velez@email.com",
    rol: "Usuario",
    estado: "Inactivo",
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "3344556677",
    nombre: "Mateo Ballesteros",
    telefono: "3101122334",
    email: "mateo.ballesteros@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
    ...
    telefono: "3012233445",
    email: "juliana.patino@email.com",
    rol: "Editor",
    estado: "Inactivo",
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "7788990011",
    nombre: "Felipe Moncada",
    telefono: "3203344556",
    email: "felipe.moncada@email.com",
    rol: "Usuario",
    estado: "Activo",
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "9900112233",
    nombre: "Valeria Ocampo",
    telefono: "3114455667",
    email: "valeria.ocampo@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
  ...
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "5566778899",
    nombre: "Óscar Restrepo",
    telefono: "3107788990",
    email: "oscar.restrepo@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
    ...
    documento: "PPT",
    numeroDocumento: "7788990011",
    nombre: "Camila Bernal",
    telefono: "3018899001",
    email: "camila.bernal@email.com",
    rol: "Editor",
    estado: "Activo",
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "9900112233",
    nombre: "Juanita Gómez",
    telefono: "3209900112",
    email: "juanita.gomez@email.com",
    rol: "Usuario",
    estado: "Inactivo",
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "1122334455",
    nombre: "Miguel Ángel Rincón",
    telefono: "3110011223",
    email: "miguel.rincon@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
    ...
    telefono: "3001122334",
    email: "esteban.salazar@email.com",
    rol: "Editor",
    estado: "Inactivo",
  },
  {
  ...
  },
  {
    ...
    documento: "CC",
    numeroDocumento: "7788990011",
    nombre: "Andrés Felipe Rueda",
    telefono: "3103344556",
    email: "andres.rueda@email.com",
    rol: "Administrador",
    estado: "Activo",
  },
  {
    ...
    telefono: "3014455667",
    email: "diana.quintero@email.com",
    rol: "Editor",
    estado: "Activo",
  },
  {
    ...
    telefono: "3205566778",
    email: "tomas.cardenas@email.com",
    rol: "Usuario",
    estado: "Inactivo",
  },
];
                  ...
                  <tr key={r.id} className="hover:bg-gray-50">
                    ...
                    <Td>
                      <div className="flex items-center gap-3 text-gray-600">
                        <button className="hover:text-gray-900" title="Ver">
                          <img src="/icons/Eye.svg" className="h-4 w-4" />
                        </button>
                        <button className="hover:text-gray-900" title="Editar">
                          <img src="/icons/Edit.svg" className="h-4 w-4" />
                        </button>
                        <button className="hover:text-red-600" title="Eliminar">
