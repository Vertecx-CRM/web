...
} from "../search/genericSearchCombobox";
...
export const EditAppointmentModal: React.FC<EditAppointmentModalProps> = ({
  ...
  console.log("selected orden", selectedOrdenServicio);
  console.log("materiales de la orden", selectedOrdenServicio?.materiales);

  console.log("form data edit", formData);

  // Renderizar contenido según el tipo de cita seleccionado
  const renderTipoCitaContent = () => {
    if (!appointment || formData.tipoCita == null) {
        ...
        return (
          <div className="space-y-4">
            ...
            <SolicitudSearchCombobox
              ...
              onBlur={() =>
                handleBlur({ target: { name: "solicitud" } } as any)
              }
              ...
              <div className="p-4 rounded-md bg-gray-50 border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    {selectedSolicitud.monto.toLocaleString()} COP
                  </div>
            ...
            {selectedOrdenServicio && (
              <div className="p-4 rounded-md bg-gray-50 border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  <div>
                    <span className="font-medium">Cliente:</span>{" "}
                    {selectedOrdenServicio.cliente}
                  </div>
                  <div>
                    <span className="font-medium">Servicio:</span>{" "}
                    {selectedOrdenServicio.servicio}
                  </div>
                  <div>
                    <span className="font-medium">Dirección:</span>{" "}
                    {selectedOrdenServicio.direccion}
                  </div>
                  <div>
                    <span className="font-medium">Monto:</span> $
                    {selectedOrdenServicio.monto.toLocaleString()} COP
                  </div>
                  {selectedOrdenServicio.descripcion && (
                    <div className="col-span-2">
                      <span className="font-medium">Descripción:</span>{" "}
                      {selectedOrdenServicio.descripcion}
                    </div>
                ...
                <div className="grid grid-cols-2 gap-2 text-sm">
                  ...
                  {selectedOrdenServicio.materiales.length > 0 && (
                    <div className="col-span-2">
                      ...
                      {selectedOrdenServicio.materiales
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          >
            ...
            <div className="space-y-4">
                ...
                <div className="flex-1">
                  ...
                  {touched.horaInicio && errors.horaInicio && (
                    <p
                      ...
                      style={{ color: Colors.states.inactive }}
                    >
                      {errors.horaInicio}
                    </p>
                  )}
              ...
              <div
                className="w-full h-0 outline outline-1 outline-offset-[-0.5px] my-4"
        ...
        <div
          ...
          style={{
            ...
            backgroundColor: Colors.table.primary,
          }}
        >
