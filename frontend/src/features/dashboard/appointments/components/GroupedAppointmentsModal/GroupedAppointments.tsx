      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            {onCreateAppointment && (
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.backgroundColor = "#B20000")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.backgroundColor = Colors.buttons.primary)
                }
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {appointments.map((appointment) => {
            const estado = appointment.estado?.toLowerCase() as keyof typeof Colors.states.appointment;
            const subestado = appointment.subestado;
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className="text-sm"
                    style={{ color: Colors.texts.secondary }}
                  >
                ...
                <div className="text-sm" style={{ color: Colors.texts.secondary }}>
                  Técnicos:{" "}
                  {appointment.tecnicos.map((t) => t.nombre).join(", ") || "N/A"}
                </div>
                ...
                >
                  {appointment.estado}
                  {subestado && (
                    <span className="ml-1 italic">({subestado})</span>
                  )}
                </div>
              </div>
            );
