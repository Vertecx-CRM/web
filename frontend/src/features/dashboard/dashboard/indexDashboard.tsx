    ...
    <div className="w-full h-screen overflow-y-auto overflow-x-hidden p-4">
      ...
      <div className="flex flex-wrap gap-4 justify-center md:justify-start">
        ...
        <div className="p-3 w-full sm:w-[calc(50%-1rem)] md:w-[calc(25%-1rem)]">
          <div className="bg-[#F4F4F4] rounded-lg p-5 shadow-md h-full">
            <div className="bg-[#B20000] text-white rounded-lg p-4 sm:p-6 flex items-center h-full">
              <Image src="/icons/cash-stack.svg" alt="Ventas" width={40} height={40} className="mr-4 filter brightness-0 invert" />
        ...
        <div className="p-3 w-full sm:w-[calc(50%-1rem)] md:w-[calc(25%-1rem)]">
          <div className="bg-[#F4F4F4] rounded-lg p-5 shadow-md h-full">
            <div className="bg-[#B20000] text-white rounded-lg p-4 sm:p-6 flex items-center h-full">
              <Image src="/icons/cart2.svg" alt="Compras" width={40} height={40} className="mr-4 filter brightness-0 invert" />
              <div className="flex-grow">
        ...
        <div className="p-3 w-full sm:w-[calc(50%-1rem)] md:w-[calc(25%-1rem)]">
          <div className="bg-[#F4F4F4] rounded-lg p-5 shadow-md h-full">
            <div className="bg-[#B20000] text-white rounded-lg p-4 sm:p-6 flex items-center h-full">
              <Image src="/icons/calendar.svg" alt="SolicitudServicio" width={50} height={50} className="mr-4 filter brightness-0 invert" />
              <div className="flex-grow">
                <h2 className="text-lg font-medium">Solicitud de servicio:</h2>
        ...
        <div className="p-3 w-full sm:w-[calc(50%-1rem)] md:w-[calc(25%-1rem)]">
          <div className="bg-[#F4F4F4] rounded-lg p-5 shadow-md h-full">
            <div className="bg-[#B20000] text-white rounded-lg p-4 sm:p-6 flex items-center h-full">
              <Image src="/icons/box.svg" alt="Órdenes" width={40} height={40} className="mr-4 filter brightness-0 invert" />
              <div className="flex-grow">
                <h2 className="text-lg font-medium">Órdenes de servicio:</h2>
